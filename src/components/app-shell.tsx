...
import { UserIcon, HomeIcon, PlusCircleIcon, WrenchScrewdriverIcon, CheckCircleIcon, BookOpenIcon, ChartBarIcon, UsersIcon, HandRaisedIcon } from "@heroicons/react/24/outline";
...
const NAV_ITEMS = [
  ...
  { href: "/historique-livraisons", label: "Livrées", icon: <HandRaisedIcon className="h-5 w-5" /> },
